<?php
/**
 * Standalone install + heartbeat reporter for Panth_IndexerManager.
 *
...
namespace Panth\IndexerManager\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_IndexerManager';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-indexer-manager';
